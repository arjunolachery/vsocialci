...
<div class="row">
    ...
    <div class="row">
      ...
      <div class="col-lg-6"><br><br><br>
        ...
        <div class="row back_white">
          <div class="col-lg-12">
            <br><br>
            <center><img id="setting_side_profile_pic" src="<?php echo $profile_pic_file_name?>" style="border:thin solid #ccc;border-radius:100%;" height="128px" width="128px" class="image_user_settings"><br><br><span class="user_name_setting"><?php echo $retrieved_settings['0']['name'];?></span></center><br><br>
          </div>
        </div>
      </div>
  ...
  <div class="col-lg-6">
    ...
    <table width="100%">
      <tr class="settings_option_title_tr">
        <td class="settings_td settings_td_title" width="1%"><span style="display:inline;white-space:nowrap;" class="settings_title_theme" id="position_upload">Personal Info</span></td>
        <td class="settings_td add_border_settings_tab" width="98%"></td>
        <td class="settings_td add_border_settings_tab" width="1%">
          <div style="display:inline" align="right">
            <!--<button class="side_button" id="settings_button_actual_close"><img src="../../assets/images/error.png"></button>--></div>
        </td>
      </tr>
    </table>
  ...
  <td class="settings_td" width="25%" style="text-align:right"><span class="settings_sub_title">Date of Birth</span></td>
      ...
      <tr>
        <td class="settings_td" colspan="5"><br>
          <center>
            <div id="save_personal_information_container"><button class="btn btn-success save_button" id="save_personal_information">Save Changes</button></div>
            <div id="save_personal_information_container2"></div>
          </center>
        </td>
      </tr>
    ...
    <table width="100%">
      <tr class="settings_option_title_tr">
        <td class="settings_td settings_td_title" width="1%"><span style="display:inline;" class="settings_title_theme">Preferences</span></td>
        <td class="settings_td add_border_settings_tab" width="99%"></td>
      </tr>
    </table>
    ...
    <table width="100%">
      <tr class="settings_option_title_tr">
        <td class="settings_td settings_td_title" width="1%" style="white-space: nowrap;"><span style="display:inline;" class="settings_title_theme">Change Password</span></td>
        <td class="settings_td add_border_settings_tab" width="99%"></td>
      </tr>
    </table>
    ...
    <table class="settings_table_content" cellpadding="200" width="100%">
      ...
      <tr>
        <td class="settings_td" colspan="5"><br>
          <center>
            <div id="save_password_container"><button class="btn btn-success save_button" id="save_password">Change Password</button></div>
            <div id="save_password_container2"></div>
          </center>
        </td>
      </tr>
...
<script>
  ...
  $("#save_personal_information").click(function() {
    ...
    $.post("<?php echo site_url().'/User_functions/update_personal_information';?>", {
        gender: gender_value,
        dob: date_birth
      },
      function(response) {
  ...
  $.fn.update_preferences = function() {
    $.post("<?php echo site_url()?>/user_functions/update_preferences", {
        'auto_login_val': auto_login_val,
        'welcome_screen_val': welcome_screen_val,
  ...
  $('#save_password').click(function() {
    ...
    $.post("<?php echo site_url()?>/user_functions/change_password", {
        'current_password': $('#current_password_set').val(),
  ...
  setTimeout(function() {
    ...
    $('#image_cover').offset({
      top: position_image_top + 1,
      left: position_image_left + 1
    });
  }, 100);
