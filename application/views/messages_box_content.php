...
foreach ($messages as $key) {
  ...
  if($key['u_id']==$uid)
  {
    ...
    echo "<div class='row'>
      ...
      <div class='col-lg-4 text-right'><span class='message_display_left'>".$key['content_message']."</span></div>
    ...
    echo "<div class='row'>
      ...
      <div class='col-lg-4'><span class='message_display_left'>".$key['content_message']."</span></div>
