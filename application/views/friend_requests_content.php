      ...
      if (empty($friend_requests)) {
          ...
          foreach ($friend_requests as $key) {
              if ($key['time_friend']>$checked_on[0]['time_checked_on']) {
                  echo "<a href='".site_url()."/user/profile?email=".$key['email']."'><div class='flex_container name_friend_list_container_new'><img src='".base_url()."uploads/".$key['profile_pic_file_name']."' width='64px'><div>&nbsp;&nbsp;&nbsp;&nbsp;</div><div class='name_friend_list'>".$key['name']."</div><div>&nbsp;&nbsp;&nbsp;&nbsp;</div><div class='friend_new'>new</div></div></a>";
              } else {
                  echo "<a href='".site_url()."/user/profile?email=".$key['email']."'><div class='flex_container name_friend_list_container'><img src='".base_url()."uploads/".$key['profile_pic_file_name']."' width='64px'><div>&nbsp;&nbsp;&nbsp;&nbsp;</div><div class='name_friend_list'>".$key['name']."</div></div></a>";
              }
          }
      }
      ?>
