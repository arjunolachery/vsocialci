...
foreach ($query->result_array() as $row)
{
  ...
  $postid=$row['id'];
  $content=$row['content'];
    echo "<div class='row'><div class='col-lg-5 text-center'><span id='namePost".$postid."' class='namePost'>";
        ...
        echo "><img src='".base_url()."assets/images/remove.png'></button><button class='sideButton'><img src='".base_url()."assets/images/up-arrow.png'></button><button class='sideButton'><img src='".base_url()."assets/images/chevron.png'></button></span></div></div><hr>";
