  ...
  <div class="col-lg-3"></div>
    <div class="col-lg-6">
      ...
      foreach ($select_posts_votes_result as $key) {
        ...
        echo "<a href='".site_url()."/user/profile?email=".$email."'><div class='flex_container name_friend_list_container'><img src='".$profile_pic_link_user."' width='64px'><div>&nbsp;&nbsp;&nbsp;&nbsp;</div><div class='name_friend_list'>".$user_name." ".$vote_status." your ".$message_type." by ".$key['val']."</div></div></a>";
