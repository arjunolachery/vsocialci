...
?>
  <script>
    ...
    function send_friend_request() {
      $.post("<?php echo $link_send?>", {
        'friend_id': <?php echo $friend_uid?>
      }, function(data) {
    ...
    function get_friendship_status() {
      $.post("<?php echo $link_get_status?>", {
        'email': '<?php echo $retrieved_settings[0]['
        email '];?>'
      }, function(data) {
    ...
    function get_friendship_status_2() {
      $.post("<?php echo $link_get_status_2?>", {
        'email': '<?php echo $retrieved_settings[0]['
        email '];?>'
      }, function(data) {
        if (data != 3) {
