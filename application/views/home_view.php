...
<div class="col-lg-3" style="padding:0.17em 0em 0em 0.4em"><span>vsocial</span>  <button class="side_button" id="profileButtonOpen"><img src="../../assets/images/user.png"></button></div>
